...
ENV ANDROID_BUILD_TOOLS_VERSION build-tools-23.0.3,build-tools-25.0.2,build-tools-26.0.1,build-tools-27.0.3

ENV ANDROID_SDK_FILENAME android-sdk_${ANDROID_SDK_VERSION}-linux.tgz
ENV ANDROID_SDK_URL http://dl.google.com/android/${ANDROID_SDK_FILENAME}
ENV ANDROID_API_LEVELS android-23,android-25,android-26,android-27
