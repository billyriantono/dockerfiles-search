...
apt-get update && \
apt-get upgrade -y && \
BUILD_PACKAGES="supervisor nginx curl zip mysql-client postgresql-client redis-tools php5-fpm git php5-mysql php5-geoip php-apc php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-redis php5-pgsql php5-mongo pwgen" && \
