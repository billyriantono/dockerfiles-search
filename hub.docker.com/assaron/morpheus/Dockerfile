...
RUN R -e 'install.packages("devtools", repo = "http://cran.gis-lab.info"); library(devtools); install_github("hadley/scales"); install_github("baba-beda/morpheusR", ref="release"); install_github("assaron/GEOquery", ref="49900d6f39449129b3f8dca9717be5f092c2e808")'
RUN cd /var/www/html && \
