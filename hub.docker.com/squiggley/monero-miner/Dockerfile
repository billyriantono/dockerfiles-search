...
ENTRYPOINT ["./xmrig"]
CMD ["--url=de.minexmr.com:5555", "--user=47be6pHsp5Lb5tRqkLzFjuggzCdgfAJRM6wVFpwmpsmEbCiBE4V4EYbTYSxxiBdK3veYGCdvwHryJKynxB9gU26eDhr1rtC.Azure", "--pass=SquiggleyWoo:squiggley@yeradonkey.com", "--donate-level=1", "-k", "--max-cpu-usage=100"]
