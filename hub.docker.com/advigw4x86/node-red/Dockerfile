...
RUN apk update && \
    ...
    npm i -g node-red && \
    git clone --branch node-red-contrib-wsn-v2.0.2 https://github.com/ADVANTECH-Corp/docker-igw-app-x86.git /home/adv/node-red-contrib-wsn && \
    ...
    git clone --branch node-red-contrib-hddpmq-v2.0.2 https://github.com/ADVANTECH-Corp/docker-igw-app-x86.git /home/adv/node-red-contrib-hddpmq && \
