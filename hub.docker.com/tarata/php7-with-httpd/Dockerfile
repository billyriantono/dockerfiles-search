...
RUN yum update -y
RUN yum install -y mod_ssl tree sendmail sendmail-cf vim mysql nc git unzip
RUN yum install -y --enablerepo=remi,remi-php71 php php-common php-mysql php-xml php-simplexml httpd php-pecl-xdebug php-mbstring
