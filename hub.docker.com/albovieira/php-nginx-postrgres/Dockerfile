...
RUN apt-get -y install php5-fpm php5-xdebug php5-pgsql php-apc php5-mcrypt php5-curl php5-gd php5-json php5-cli libssh2-php
...
RUN echo "xdebug.remote_autostart=off" >> /etc/php5/mods-available/xdebug.ini
#RUN echo "xdebug.$XDEBUG_CONFIG" >> /etc/php5/mods-available/xdebug.ini
...
ADD sites/default.conf /etc/nginx/sites-available/default
