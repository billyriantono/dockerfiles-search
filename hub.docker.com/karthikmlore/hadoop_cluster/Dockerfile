...
# docker run -itd --name datanode3 --net hadoop --hostname datanode3 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
# docker run -itd --name datanode4 --net hadoop --hostname datanode4 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
# docker run -itd --name datanode5 --net hadoop --hostname datanode5 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
# docker run -itd --name datanode6 --net hadoop --hostname datanode6 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
# docker run -itd --name datanode7 --net hadoop --hostname datanode7 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
# docker run -itd --name datanode8 --net hadoop --hostname datanode8 --memory 1024m --cpus 2 karthikmlore/hadoop_cluster
