...
# Icon add routino
WORKDIR /var/www/html/routino/www/routino/icons/
ADD icon/icons.zip /var/www/html/routino/www/routino/icons/
RUN unzip ./icons.zip && rm -f ./icons.zip

# Custom routino
COPY js/mapprops.js /var/www/html/routino/www/routino
COPY js/profiles.js /var/www/html/routino/www/routino

# latest new version
COPY js/router.leaflet.js /var/www/html/routino/www/routino
