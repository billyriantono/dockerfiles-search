...
RUN wget -O tmp.zip http://dl.google.com/android/repository/android-ndk-${NDK_VERSION}-linux-x86_64.zip && unzip tmp.zip && rm tmp.zip && ./make-toolchain.sh && rm -rf android-ndk-${NDK_VERSION}
