...
RUN apt-get install -y php5 php5-fpm php-pear php5-dev php5-common php5-json php5-memcache php5-memcached php5-xsl php5-mongo php5-mcrypt php5-mysql php5-cli php5-gd php5-intl php5-curl git ruby build-essential
