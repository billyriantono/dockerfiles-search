...
RUN CHROMEDRIVER_VERSION=$(/usr/bin/curl -sS chromedriver.storage.googleapis.com/LATEST_RELEASE) && \
...
RUN apt-get update && apt-get install -y iceweasel && apt-get clean
