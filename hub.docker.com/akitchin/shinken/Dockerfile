...
RUN apt-get update && apt-get install -y python python-gtk2  python-jswebkit libwebkitgtk-1.0-0 python-webkit python-imaging xvfb supervisor wget python-pymongo ssh mongodb nagios-plugins && apt-get -y autoremove && apt-get clean
