...
RUN set -x && \
    ...
    gpg --keyserver hkp://gpg.nebrwesleyan.edu:80 --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4 && \
...
RUN set -x \
  ...
  && export GNUPGHOME="$(mktemp -d)" \
  && gpg --keyserver hkp://gpg.nebrwesleyan.edu:80 --recv-keys 91A6E7F85D05C65630BEF18951852D87348FFC4C \
